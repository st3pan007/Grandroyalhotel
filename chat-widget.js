...
(function() {
    ...
    widgetStyles.textContent = `
        .chat-assist-widget {
            ...
            --chat-shadow-sm: 0 1px 3px rgba(212, 175, 55, 0.1);
            --chat-shadow-md: 0 4px 6px rgba(212, 175, 55, 0.15);
            --chat-shadow-lg: 0 10px 15px rgba(212, 175, 55, 0.2);
            --chat-radius-sm: 8px;
            --chat-radius-md: 12px;
            --chat-radius-lg: 20px;
    ...
    const chatInterfaceHTML = `
        <div class="chat-body">
            ...
            <div class="chat-controls">
                <textarea class="chat-textarea" placeholder="Napište zprávu..." rows="1"></textarea>
    ...
    launchButton.innerHTML = `
        ...
        <span class="chat-launcher-text">Potřebujete pomoc?</span>`;
    ...
    async function startChat() {
        ...
        try {
            ...
            errorMessage.textContent = "Omlouvám se, momentálně mám potíže s připojením. Zkuste to prosím za chvíli.";
    ...
    async function submitMessage(messageText) {
        ...
        try {
            ...
            const errorMessage = document.createElement('div');
            errorMessage.className = 'chat-bubble bot-bubble';
            errorMessage.textContent = "Omlouvám se, momentálně mám technické potíže. Zkuste to prosím za chvíli.";
            messagesContainer.appendChild(errorMessage);
            messagesContainer.scrollTop = messagesContainer.scrollHeight;
        } finally {
